...
//    private final static Logger logger = LoggerFactory.getLogger(IDGenerator.class);
        ...
        private final long workerIdBits = 4L;      // 机器标识位数 16个节点
        private final long maxWorkerId = -1L ^ -1L << this.workerIdBits;// 机器ID最大值: 1023
        private long sequence = 0L;                   // 0，并发控制
        private final long sequenceBits = 4L;      //毫秒内自增位
...
//            try {
//                return sdf.parse("2038-12-10 12:13:57").getTime();
